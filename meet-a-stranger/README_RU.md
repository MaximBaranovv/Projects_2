...
### Описание
Перейдите в класс [MeetAStranger](src/main/java/com/project/rd/autotasks/meetastranger/MeetAStranger.java) и напишите программу, которая прочтет строку из `System.in` и выведет сообщение: "Hello, *прочитанная строка*".
